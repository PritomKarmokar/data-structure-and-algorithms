...
// else return left most occurrence of the target value
int search(vector<int> &nums, int target)
{
    ...
    while(start <= end){
        ...
        if(nums[mid] == target){
            index = mid;
            end = mid - 1; // continue searching in the left portion after one occurrence is found
        }
...
int main()
{
    ...
    cout<<"The left most index of the value "<<target<<" is at the index "<<index<<"\n";
